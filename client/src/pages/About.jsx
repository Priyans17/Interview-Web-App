        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="order-1 md:order-1">
                ...
                <p className="text-xl text-gray-600 font-medium leading-relaxed mb-8">
                    PrepWise is a cutting-edge platform designed
                    to revolutionize interview preparation. Our
                    mission is to empower students and job seekers with the tools
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
							PrepWise is your personal interview coach,
					...
					<div className="mt-16 bg-gray-50 rounded-2xl p-8 lg:p-12">
						<div className="text-center">
							...
							<p className="text-lg text-gray-600 max-w-3xl mx-auto">
								...
								or experienced professional, PrepWise adapts
